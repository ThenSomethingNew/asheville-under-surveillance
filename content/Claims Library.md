...
Every claim here links its evidence. Cite the source, not me: a fact traced to the LAPD Inspector General or a city audit can't be dismissed as activist talk. Claims are grouped by the argument they support.

## "The process was undemocratic"

- City staff requested the federal earmark **in 2024 without informing council**. ([CAMS chronology](https://camsavl.org/rtic-funding-vote/))
- The first [[What Is the RTIC|RTIC]] funding passed via **consent agenda** (the no-debate section for routine items) in [[2025-03-25 City Council|March 2025]]. ([BPR](https://www.bpr.org/bpr-news/2025-03-26/last-night-at-council-asheville-approves-funding-for-police-surveillance-hub))
- Council member [[Kim Roney|Roney]]'s **29 written questions** to APD about data control and constitutional implications were never publicly answered. ([BPR](https://www.bpr.org/bpr-news/2025-03-26/last-night-at-council-asheville-approves-funding-for-police-surveillance-hub))
- When 40+ residents came to speak on April 14, 2026, the item was **pulled from the agenda right before the meeting**. ([BPR](https://www.bpr.org/politics-government/2026-04-15/asheville-city-council-punts-vote-on-police-tech-funding-and-suggests-property-tax-hike))
- The [[2026-04-28 Work Session|April 28]] "work session" featured **Axon and Flock sales reps presenting to committee, with no public comment allowed**. ([CAMS](https://camsavl.org/rtic-funding-vote/))
...
- The **final [[What Axon Contracts Do|Axon contract]] was not available** for council or public review before the vote. ([GAP](https://gapavl.org/asheville-should-reject-the-proposed-rtic-axon-surveillance-expansion-until-real-oversight-and-accountability-exist/))
...
| Tactic | Documented instance | The counter |
|---|---|---|
| **Consent-agenda burial**: controversial items placed in the no-debate bundle | First RTIC money, [March 2025](https://www.bpr.org/bpr-news/2025-03-26/last-night-at-council-asheville-approves-funding-for-police-surveillance-hub); even the 2023 check-in reform itself | Read the agenda [posted each Friday](https://www.ashevillenc.gov/government/city-council-agenda/); email members demanding specific items be pulled for discussion; any single member can pull an item; make them refuse in writing |
| **Staff commits first, council learns later**: funding requested before any public process | The 2024 earmark request to [[Chuck Edwards|Rep. Edwards]], [without council's knowledge](https://camsavl.org/rtic-funding-vote/) | [[Records Center|Records-request]] pending grant applications quarterly; ask at the podium: "What surveillance funding has staff applied for that council hasn't seen?" |
| **Vanishing agenda items**: pull the vote when a crowd shows up | [April 14, 2026](https://www.bpr.org/politics-government/2026-04-15/asheville-city-council-punts-vote-on-police-tech-funding-and-suggests-property-tax-hike): 40+ speakers arrived, item disappeared | Come back. The item returns when the room is empty; sustained turnout across consecutive meetings is the only counter |
| **Vendor-led "public process"**: sales reps as the expert briefing, no comment allowed | [April 28, 2026 work session](https://camsavl.org/rtic-funding-vote/): Axon and Flock presented; the public watched in silence | Demand equal time for independent experts (EFF, ACLU-NC, academics); rebut the sales claims at the next regular meeting with the [[The National Wave|national record]] |
| **The midnight schedule**: big item last, comment capped, room exhausted | [[2026-05-12 City Council|May 12, 2026]]: end of a budget meeting, 1-hour cap, 21 speakers sent home, vote near midnight | Sign up the moment doors open; coordinate so speakers don't duplicate; email written comment (it's unlimited and enters the record even when the clock cuts you off) |
...
- **ICE:** ICE has no Flock contract, and got **4,000+ searches run for it** by local police as informal favors. Santa Cruz found ICE had accessed its data ~4,000 times and canceled. ([404 Media](https://www.404media.co/ice-taps-into-nationwide-ai-enabled-camera-network-data-shows/) · [Yahoo](https://www.yahoo.com/news/us/articles/cities-ditching-flock-safety-cameras-172924943.html))
- **Reproductive privacy:** a Texas sheriff searched **~83,000 cameras nationwide** with the logged reason "had an abortion, search for female"; no warrant, sweeping states where abortion is legal. ([EFF](https://www.eff.org/deeplinks/2025/10/flock-safety-and-texas-sheriff-claimed-license-plate-search-was-missing-person-it))
- **Officer misuse:** at least **50 officers charged with or accused of** using plate readers against partners, exes, and women they wanted to meet, 46 of 50 via Flock ([Washington Post investigation](https://www.poynter.org/commentary/2026/flock-security-camera-changes-washington-post/)), including a Charlotte officer charged July 29 and a Mooresville officer accused of **31 falsified stalking searches**, whose department then found **ten more officers** in violation and charged none. ([[The Abuse Record]])
- **Vendor honesty:** Sedona officials said they were **"misled and lied to"**; Evanston caught Flock **reinstalling terminated cameras without authorization**; the ACLU published a report documenting Flock's pattern of misrepresentations to city councils. ([ABC7](https://abc7chicago.com/post/evanston-oak-park-end-contracts-flock-safety-license-plate-reader-company-investigation-illinois/17678137/) · [ACLU](https://www.aclu.org/news/privacy-technology/tracking-alpr-cameras/flock-safety-credibility-lost-as-it-repeatedly-lies-to-city-councils-police-departments-and-public-across-the-country))
- **Security:** researchers rooted a Flock camera **in under 30 seconds**; ~70 cameras were found streaming unauthenticated online; Congress asked the **FTC to investigate**. ([Krishnamoorthi/Wyden](https://krishnamoorthi.house.gov/media/press-releases/congressman-krishnamoorthi-senator-wyden-urge-ftc-investigate-surveillance))

## "It doesn't reduce crime"

- LAPD's Inspector General: **32.3% of stolen-vehicle alerts were false positives**: an innocent driver investigated every time. LAPD dropped Flock. ([Knock LA](https://knock-la.com/lapd-suspends-contract-with-flock-safety/))
- Austin's audit: **117 million scans → 228 arrests**, and 10–20% of searches had no documented reason. ([KUT](https://www.kut.org/austin/2025-06-04/austin-tx-automatic-license-reader-program-police-data-privacy-flock))
- The peer-reviewed literature finds plate readers have **no deterrent effect** on crime; Atlantic City's camera expansion produced **no reduction in violent crime**. ([CrimRxiv](https://www.crimrxiv.com/pub/zleg04q3/release/1) · [Justice Evaluation Journal](https://www.tandfonline.com/doi/full/10.1080/24751979.2025.2473363))
- Flock's "solves 10% of US crime" claim was company-funded and publicly rejected by six criminologists. ([404 Media](https://www.404media.co/researcher-who-oversaw-flock-surveillance-study-now-has-concerns-about-it/) · [Forbes](https://www.forbes.com/sites/cyrusfarivar/2024/02/29/flock-ai-cameras-may-not-reduce-crime/))
- Innocent people pay for the errors: a Black family (four children) held **face-down at gunpoint** in Aurora, CO after a plate misread; the Institute for Justice has compiled dozens of wrongful stops and jailings. ([Gizmodo](https://gizmodo.com/cops-terrorize-black-family-but-blame-license-plate-rea-1844602731) · [IJ](https://ij.org/dozens-of-innocent-motorists-have-been-pulled-over-detained-at-gunpoint-or-jailed-due-to-ai-license-plate-camera-errors/))
