...
## Mayor: the referendum

**[[Kim Roney]]**. The record: sole no vote on the Fusus interlocal (Jan 2023), the first RTIC grant ([[2025-03-25 City Council|Mar 2025]]), and the RTIC/Axon package (May 2026). Submitted 29 written questions to APD that were never publicly answered; consulted the ACLU-NC and EFF. At the May 28 debate: concerns about "a billionaire-owned, AI-fueled, for-profit tech company... working with ICE and Homeland Security and also the police department to surveil people without a warrant." On the May 12 process: "21 people were sent home without the opportunity to speak." ([BPR debate coverage](https://www.bpr.org/politics-government/2026-05-28/at-the-first-asheville-mayor-debate-roney-and-manheimer-clash-over-transparency-and-surveillance) · [campaign site](https://kimroney4asheville.com/))

**[[Esther Manheimer]]** (incumbent, seeking a 4th term). The record: voted for every stage of the buildout. Frames the $1.14M as fiscal efficiency: the city already pays the Sheriff's Office for Fusus access, and the grant lets Asheville "pay for our own." On the transparency criticism: council needs private discussions too: "That's not a transparency issue. That's a functioning issue." Her May 17 campaign launch drew RTIC protesters. Then on **August 19**, eleven weeks before Election Day, she called for terminating the Flock contract and removing the cameras, saying "I have heard clearly from Asheville residents" ([WLOS](https://wlos.com/news/local/asheville-mayor-esther-manheimer-vote-end-city-flock-safety-contract-remove-cameras-backlash-automatic-license-plate-readers-data-surveillance)). The proposal leaves the [[What Is the RTIC|RTIC]], the [[What Axon Contracts Do|Axon contract]], and APD's [[Getting Flock Out|Flock search accounts]] untouched; her page tracks whether the statement becomes a removal. ([BPR](https://www.bpr.org/politics-government/2026-05-28/at-the-first-asheville-mayor-debate-roney-and-manheimer-clash-over-transparency-and-surveillance) · [WLOS](https://wlos.com/news/local/asheville-mayor-mayoral-campaign-esther-manheimer-city-council-member-kim-roney-community-river-arts-district-buncombe-county-board-commissioners-marquee-protest-real-time-intelligence-center-police-department) · [campaign site](https://manheimerformayor.com/))

## City Council: three seats, six candidates, near-total silence

The March primary cut twenty candidates to six. Three are incumbents who **voted yes on May 12**. Not one of the six is campaigning on the RTIC, for or against.
...
- **County Commission** (funds the Sheriff's Fusus network, and holds more levers over it than most people assume: [[What the Law Lets the County Do]]). D1: Anna Stearns (D) vs. Rob Stetson (R). D2 (open): Lonnie Israel (D) vs. Greg Parks (R). D3: Al Whitesides (D, i) unopposed. No surveillance positions found for any candidate (as of Aug 17, 2026).
- **US House, NC-11**: **[[Chuck Edwards]], who earmarked the RTIC's $1.14M, withdrew August 5** after a House Ethics Committee report. The GOP substituted state Rep. **[[Jennifer Balkcom]]**; she faces Democrat **[[Jamie Ager]]**. Neither has a public surveillance record (as of Aug 17, 2026). ([BPR](https://www.bpr.org/politics-government/2026-08-10/state-rep-jennifer-balkcom-to-replace-rep-chuck-edwards-on-nc-11-ballot) · [WLOS](https://wlos.com/news/local/chuck-edwards-withdraws-nc-11-congressional-district-race-jamie-ager-election-impact-midterm))
- **NC General Assembly (Buncombe)**. House 114: Eric Ager (D, i). House 115: Lindsey Prather (D, i) vs. Anthony Penland (R). House 116: Brian Turner (D, i). Senate 49: Julie Mayfield (D, i) vs. C.J. Domingo (R). The legislature just made highway plate readers permanent statewide, with every one of these four voting for the budget that did it; all four voted against the ICE-cooperation overrides. No Buncombe legislator has a found public position on plate readers (as of Aug 22, 2026). Every WNC legislator's roll calls, with links: [[WNC Legislators]].

## Put the question to them

No moderator is going to ask. Voters can: at forums, by email, at the door. Two questions that can't be answered with a slogan:
