...
description: The county government that built the region's surveillance backbone (sold to commissioners as a revenue opportunity) and the 1,500 school cameras nobody voted on.
---
...
Buncombe County Schools became the first WNC district on Fusus in **late 2021, via a memorandum of understanding with the Sheriff's Office**. Roughly **1,500 cameras across 43+ schools** feed the network; the district says it controls when deputies get access. What I cannot find: **any public school-board vote on the MOU, the MOU's text, any parent-notification record, or any board policy governing it**, and no board agenda has revisited camera access since national reporting showed [ICE tapping school camera networks elsewhere](https://www.the74million.org/article/ice-taps-into-school-security-cameras-to-aid-trumps-immigration-crackdown-74-investigation-shows/). ([[Quentin Miller|Sheriff Miller]] has publicly barred ICE from schools without a court order, a personal commitment, not a policy that survives him; he's on the [[Election 2026|November ballot]], and so are three school-board seats.) These are the region's premier records-request targets.

## The towns

**Black Mountain** approved 5 Flock cameras in 2022 (the one municipal deployment with published results); **Biltmore Forest quietly built out 13 cameras**: the highest per-capita ALPR density in the county, documented *only* in town minutes, with zero press coverage ever; **Woodfin, Weaverville, and Montreat** show no camera programs (unconfirmed negatives). 
...
*Related: [[WNC and NC]] · [[Quentin Miller]] · [[Follow the Money]] · [[Documents]]*
