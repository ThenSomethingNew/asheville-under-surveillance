...
> "So many of the things they've done are not only unfair, but they're unconstitutional. And who gets hurt? … at the end of this, they had the mayor saying, 'If we build it, they will come. **If you pass this, ICE will come.**'"
> — Curry First, a retired civil-rights lawyer, relaying another city's cautionary tale to council, March 25, 2025 ([22:18](https://www.youtube.com/watch?v=Bc-VVlvBx0U&t=1338s))

> "Speaking of oversight, I believe that an immediate actionable step that can be taken to reassure us, the people, is for the city of Asheville and APD to review and consider not renewing contracts with Flock. The automated license plate readers in our community are AI-driven and owned by private contractors. While these cameras are operating in our city, your constituents remain vulnerable to targeted attacks by federal agents."
> — Michaela Barry, January 13, 2026 ([1:44:23](https://www.youtube.com/watch?v=ziQVwdBcwqE&t=6263s))
...
> "I want to be direct about something I've heard from this body. The Fourth Amendment does not protect us here. The Fourth Amendment binds local government, not Axon. The records we hand over to a private company — our phone records, our bank records, the metadata on a cloud service — receive substantially less constitutional protection than records we keep ourselves."
> — Sarah Kent, May 12, 2026 ([5:31:11](https://www.youtube.com/watch?v=AfdrH-a92As&t=19871s))

> "The collection of data by police without an individual's consent or a judicial warrant, using technology that can track everyone, monitor all our public movements, and do so both in real time and retroactively, is a significant threat to our constitutional and civil rights."
> — Claire Hanrahan, May 12, 2026 ([5:40:15](https://www.youtube.com/watch?v=AfdrH-a92As&t=20415s))
...
> "If we cancel the contract, the video has a 90-day retrieval window, but the metadata does not. They keep it. They keep what their AI learned from it. We cannot claw back that data."
> — Sarah Kent, application security consultant, May 12, 2026 ([5:28:50](https://www.youtube.com/watch?v=AfdrH-a92As&t=19730s))

> "What I really want to draw your attention to is this 125% net revenue retention. … That means the average customer pays 25% more every single year, regardless of their contract. … In 2020 the city renewed a 5-year contract for Axon body cams, and the cost for years 2 to 5 of that contract jumped 86%, with the city finance manager noting that Axon prices change every year in January."
> — Aaron Dahlstrom, May 12, 2026 ([5:21:28](https://www.youtube.com/watch?v=AfdrH-a92As&t=19288s))
...
> — Vaughn, April 14, 2026 ([2:22:48](https://www.youtube.com/watch?v=QHT2NetBNmI&t=8568s))
...
> — Jessica Myers, contract attorney, May 12, 2026 ([6:02:17](https://www.youtube.com/watch?v=AfdrH-a92As&t=21737s))
...
> — Nicole Lopez, technologist, May 12, 2026 ([5:55:21](https://www.youtube.com/watch?v=AfdrH-a92As&t=21321s))
...
> — Wendell Wilson, May 12, 2026 ([5:57:20](https://www.youtube.com/watch?v=AfdrH-a92As&t=21440s))

> "Poverty is violence. … We have 15% of children in Asheville living in poverty. And the majority of folks living in poverty in Asheville are people of color. … I'm just now realizing, after all this discussion has happened, that working in housing has probably put my car, my license plate on plenty of cameras that are accessed by folks all over this nation."
> — Jessica McLean, who works at Pisgah View Apartments, April 14, 2026 ([2:40:13](https://www.youtube.com/watch?v=QHT2NetBNmI&t=9613s))

> "These Flock safety cameras — I know that there are at least two that I know of that watch me when I go to work. At least two on the way, at least two on the way home."
> — Ethan Steel, April 14, 2026 ([2:33:34](https://www.youtube.com/watch?v=QHT2NetBNmI&t=9214s))
...
> — Cassandra Howe, mom and minister, May 12, 2026 ([5:54:05](https://www.youtube.com/watch?v=AfdrH-a92As&t=21245s))

> "When you stand in this room and you vote on rules, you choose to sharpen the teeth of authority or to dull them."
> — William Emerson, April 14, 2026 ([2:11:40](https://www.youtube.com/watch?v=QHT2NetBNmI&t=7900s))

## What actually keeps us safe

Speaker after speaker made the same affirmative case: safety is built from the bottom up, and the evidence for that is stronger than the evidence for surveillance.
...
> — Molly Rickert, March 25, 2025 ([24:39](https://www.youtube.com/watch?v=Bc-VVlvBx0U&t=1479s))

> "Let's be clear. The need for public safety is real. Families shouldn't have to sleep on the floor of their homes for fear of stray bullets. But Big Brother is not the answer. Big Brother is never the answer. Lasting safety is systemic. … Today's helpful technology under an accountable, responsible government is tomorrow's tool of oppression under leadership that doesn't care in the slightest about due process or civil rights."
> — Nina Tovish, May 12, 2026 ([5:46:13](https://www.youtube.com/watch?v=AfdrH-a92As&t=20773s))

> "Science tells us again and again that what reduces crime is not policing or surveillance, but affordability and social programming."
> — Mo Knight, May 12, 2026 ([5:51:29](https://www.youtube.com/watch?v=AfdrH-a92As&t=21089s))
...
> — David Greenson, May 26, 2026 ([53:00](https://www.youtube.com/watch?v=Ve1dEYMm6o0&t=3180s))
...
> "The reason people are so concerned is because we are removing citizen oversight and expanding surveillance. That is a dangerous combination. … I just don't see how our city can approve a 7-and-1/2-year, multi-million-dollar vendor commitment whose binding operational terms do not yet exist in reviewable form."
> — Patrick Conant, director of Sunshine Labs, May 12, 2026 ([5:58:29](https://www.youtube.com/watch?v=AfdrH-a92As&t=21509s))

> "The police chief was given from 9:47 to 10:26 to talk, but we get an hour. And also, there wasn't an expert that presented on our side."
> — Canyon De Luca, May 12, 2026 ([6:15:18](https://www.youtube.com/watch?v=AfdrH-a92As&t=22518s))
...
| Date | Meeting | Video |
|---|---|---|
| Jan 14, 2025 | Regular City Council | [youtube.com/watch?v=rW6a8D3jXKU](https://www.youtube.com/watch?v=rW6a8D3jXKU) |
| Mar 25, 2025 | Regular City Council ([[2025-03-25 City Council|RTIC grant on consent agenda]]) | [youtube.com/watch?v=Bc-VVlvBx0U](https://www.youtube.com/watch?v=Bc-VVlvBx0U) |
| Sep 9, 2025 | Regular City Council | [youtube.com/watch?v=HVuW4HrBQzU](https://www.youtube.com/watch?v=HVuW4HrBQzU) |
| Jan 13, 2026 | Regular City Council | [youtube.com/watch?v=ziQVwdBcwqE](https://www.youtube.com/watch?v=ziQVwdBcwqE) |
