...
| What | When it appeared |
|---|---|
| The facial recognition ban | **July 9.** Absent from the June 25 and June 29 drafts, even though APD's own policy manager told the workgroup on June 11 that council's resolution requires the policy to "explicitly prohibit" it |
| Audits by Professional Standards instead of the Intelligence Section auditing itself | July 9 (June 29 had the Intelligence Section commander inspecting his own section's queries) |
| "Domestic ... intelligence data" dropped from the intelligence-gathering scope | July 9 (June 25 and June 29 both covered "domestic and criminal intelligence data") |
| Softer public-event language | July 9. The June 25 draft authorized the RTIC to "utilize available technological resources near relevant events to look for suspicious activity leading up to and during the event"; the final says "assisting in planning ... to provide support, information gathering" |
...
| **Manual review of ALPR hotlist entries "at least once per shift"**, removing stale plates | June 29 draft (1703.3.D), gone by July 9, along with the whole ALPR-procedures section, now just a pointer to [[Documents|Policy 505]] |
| **A Live Feed Audit form for every livestream activation** | June 29 draft, gone by July 9; the final tracks livestreams only through the quarterly random review |
...
- **A new facial recognition promise.** Stepp, June 11: any future use of facial recognition "would require a **return to Council for approval**" and "cannot be activated without a formal policy revision and specific authorization." That commitment now sits in [[Promise Tracker|the tracker]]; note that the policy itself contains no return-to-council requirement.
...
| Document | Public link | Archived |
|---|---|---|
| Policy 1703, final draft (undated) | [Drive](https://drive.google.com/file/d/1XfHU2O_PkpF8LJxT4AawyiO2iMat3jaF/view) | [copy](assets/policy-1703/policy1703-final-draft.pdf) |
| Policy 1703, draft of June 25, 2026 | [Drive](https://drive.google.com/file/d/1ZCzGdikLM9-9U1vJSXpIt5Sc21U1x-wH/view) | [copy](assets/policy-1703/policy1703-draft-0625.pdf) |
| Policy 1703, draft of June 29, 2026 | [Drive](https://drive.google.com/file/d/1-CrrSw5mxyNCV7rtYoiQ2LZ1akASIArU/view) | [copy](assets/policy-1703/policy1703-draft-0629.pdf) |
| Policy 1703, draft of July 9, 2026 | [Drive](https://drive.google.com/file/d/1A5Jbbz3MH8yD4EVLskildpibUFt8SK3W/view) | [copy](assets/policy-1703/policy1703-draft-0709.pdf) |
| RTIC Stakeholder Policy Workgroup meeting notes (June 11 – July 23) | [Drive](https://drive.google.com/file/d/1VNPa2h-UaLC6hMQLYRle9f3Jkr-46vVn/view) | [copy](assets/policy-1703/rtic-workgroup-notes.pdf) |
| ACEIP opt-out email chain (July 15–16) | [Drive](https://drive.google.com/file/d/1ZJEwMFsPwJDuhdOJGq-a22YJBEYUD22E/view) | [copy](assets/policy-1703/axon-ceip-appendix.pdf) |
| Axon contract / DOJ grant email chain (July 8–16) | [Drive](https://drive.google.com/file/d/1cQbTc4IA7maZGdm_YaFKf9cUFIt_MmNT/view) | [copy](assets/policy-1703/axon-contract-doj-email.pdf) |

A sourcing note: the workgroup quotes above come from APD's own meeting minutes, which summarize rather than transcribe; where the notes render someone in the first person I've quoted the notes exactly, but treat them as the department's record of what was said, not a recording. And one spelling correction made site-wide with this release: the city's own records (including his email address) spell the deputy chief's name **Sean Aardema**; WLOS's coverage, which several pages here cite, spells it Shawn.
