...
- **City of Asheville** (APD, city clerk, city attorney records): [the city's JustFOIA portal](https://cityofashevillenc.justfoia.com/publicportal/home/newrequest); no account required. (The city switched from NextRequest July 1, 2025; the old portal is gone. Questions about past requests: opengov@ashevillenc.gov. [City info page](https://www.ashevillenc.gov/service/request-public-records/))
- **Buncombe County** (Sheriff's Office, county finance): [the county's NextRequest portal](https://buncombecountync.nextrequest.com/). ([Fee schedule](https://www.buncombecounty.org/common/publicRelations/public-records-request-fee-schedule.pdf))
- **Buncombe County Schools**: no records portal; email **communications@bcsemail.org** (the superintendent is the legal custodian; BCS Communications, 175 Bingham Road, Asheville 28806, 828-350-2261).
- **Housing Authority (HACA)**: a public body under NC records law, no published records process; email **info@haca.org** or write to 165 South French Broad Ave., Asheville 28801.
- **NC State Bureau of Investigation**: no portal or published records email; use the ["Public Information" topic on the contact form](https://www.ncsbi.gov/Contact-Us) or write to PO Box 29500, Raleigh, NC 27626.

A request needs no magic words. State that you are requesting public records under N.C.G.S. Chapter 132, describe the records, ask for electronic copies, and ask them to identify any portion they withhold and the specific statutory basis. That last sentence matters most. Your rights, in the statute's own words: records are ["the property of the people"](https://www.ncleg.gov/EnactedLegislation/Statutes/HTML/BySection/Chapter_132/GS_132-1.html) (G.S. 132-1(b)); any person may inspect them, and ["no person... shall be required to disclose the purpose or motive for the request"](https://www.ncleg.gov/EnactedLegislation/Statutes/HTML/BySection/Chapter_132/GS_132-6.html) (G.S. 132-6(b)); copies must come "as promptly as possible" at no more than actual reproduction cost (G.S. 132-6.2). One honest caveat: for very large requests, agencies may add a "special service charge" for "extensive" IT or clerical work (G.S. 132-6.2(b)); keep requests specific, and ask for an estimate before they run the meter.
