...
**"Own the narrative before someone else does."** / "Opponents have a very carefully scripted narrative. They come prepared. **You should also have a carefully scripted presentation.**"
→ *Asheville:* APD's April 28 presentation came with **speaker notes coaching the presenter to "get ahead of the question about 2 RTICs in our county"** ([[2026-04-28 Work Session]]), a scripted pre-emption.

**Pre-brief officials privately:** "The agencies that navigate these conversations successfully **rarely wait until a council meeting to educate stakeholders.**"
→ *Asheville:* the [[The Check-In Meetings|three-by-three private check-ins]] (unminuted small-group sessions with council before every public meeting) are this advice at scale: the persuasion happens before the public meeting, off the record.
...
→ *Asheville:* "This is not about software — **this is about victims**" (Stepp, May 12); the Foster-case anecdote as the recurring justification; [[Esther Manheimer|Manheimer]]'s savings framing ([[Their Claims vs The Record|which doesn't survive arithmetic]]).
...
- **The "Nova" leak**: 404 Media obtained internal materials on Flock's people-lookup product: "You're going to be able to… **jump from LPR to person**… link to other people that are related… marriage or through gang affiliation." The car-tracking company describes its future as person-tracking. ([404 Media](https://www.404media.co/license-plate-reader-company-flock-is-building-a-massive-people-lookup-tool-leak-shows/))
...
- **Asheville's Flock procurement, for the record:** the contract runs through reseller Insight Public Sector; a two-year term from Feb 1, 2025 to Feb 2027 (the chief's August 14, 2026 memo says Flock was "added" in February 2025, which fits; earlier coverage put the cameras at April 2024); and the 11-camera deployment appears to have been **grant-funded and administrative; no standalone council vote has been found for it**. The public debate only began when the RTIC money surfaced, two years into the scanning. Result to date: **3.1 million plates scanned, ~5,000 hot-list matches.**
