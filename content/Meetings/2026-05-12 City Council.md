...
The night's first speaker, resident Ben Spencer, compared the city's process for a **one-mile sidewalk** (a 2016 bond referendum, public input surveys in 2020 and 2022, a public information meeting in February) with its process for the surveillance package:

> "If you go to the city council minutes archives... No results when you search Axon, no results if you search Fusus, no results if you search RTIC... On ashevillenc.gov, that's zero results for Axon, zero results for Fusus, zero results for RTIC... Again, there's just no information, not even a contract."
...
- **The closer**: Ben Spencer, thirty seconds, quoting the chief's own presentation back to the dais: "public safety cannot come at the expense of community values" ([6:18:50](https://www.youtube.com/watch?v=AfdrH-a92As&t=22730s)).
...
> "All right. We have a motion and a second for the B1—"

The room erupted ("SIX HOURS TO LISTEN TO EVERYONE SPEAK"), followed by applause and shouting. Somewhere in that uproar, off-microphone, the vote happened. It is not audible on the city's own recording. What *is* audible, shouted into a microphone [(6:21:19)](https://www.youtube.com/watch?v=AfdrH-a92As&t=22879s):
...
And then, beginning her presentation *after* the vote it addressed [(6:23:10)](https://www.youtube.com/watch?v=AfdrH-a92As&t=22990s):

> "I know that the vote already passed. But the public record is important... these conversations about surveillance and billionaire-owned tech have been coming up for the past 4 years, and it's been pretty quiet in City Hall. Why now?... our authoritarian federal government has deployed armed federal agents to terrorize Americans across the country and violate Fourth Amendment rights. I'm hearing neighbors ask local elected officials to protect them."
...
## The official minutes confirm it
